import { Controller, Post, Get, Patch, Delete, Param, Request, UseGuards, HttpStatus, BadRequestException } from '@nestjs/common';
...
export class SubscriptionController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Subscription created successfully', type: Subscription })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Premium subscription activated', type: Subscription })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid user ID or subscription type' })
  ...
  async subscribeToPremium(
    ...
    return await this.subscriptionService.subscribeToPremium(req.user._id, type);
  }

  @UseGuards(JwtAuthGuard)
  @Get()
  @ApiOperation({ summary: 'Get subscription status' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Subscription status retrieved', type: Subscription })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid user ID' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Subscription not found' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Subscription cancelled', type: Subscription })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid user ID' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Subscription not found' })
