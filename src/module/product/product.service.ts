...
//         console.error('[ProductService][getProductHistory] Invalid page number:', { page });
//         throw new BadRequestException('Page must be a positive number');
//       }
//       if (isNaN(limit) || limit < 1) {
//         console.error('[ProductService][getProductHistory] Invalid limit:', { limit });
...
//       // Debug: Check product without owner filter
...
//       // Simulate history using product details
//       const history = [
//         {
...
//       // Debug: Check product without owner/store filter
